                ...
                <Row className="justify-content-center">
                  <Col lg={9}>
                    <div className="home-content text-center">
                      <p className="mb-0 text-white">OPEN SOURCE</p>
                      <img src={HomeUrl} height="15" alt="" />
                      <h1 className="mt-4 pt-3 home-title text-white">Make your Site Amazing & Unique with <span className="element text-primary" data-elements="MOSP"><Typewriter
                              options={{
                                strings: ['MOSP'],
                                autoStart: true,
                                loop: true,
